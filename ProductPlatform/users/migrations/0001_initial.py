    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=120, unique=True, verbose_name='Элеектронная почта')),
                ...
                ('role', models.CharField(choices=[('Customer', 'Customer'), ('Supplier', 'Supplier')], max_length=120, verbose_name='Роль')),
